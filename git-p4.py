...
class P4Sync(Command, P4UserMap):
    ...
    def extractFilesFromCommit(self, commit, shelved=False, shelved_cl = 0):
        """ Given a dictionary of files and their revisions generated by p4_describe,
            (a dict of 'depotFile0', 'depotFile1', ...'depotFileN' objects), return the
            subset that the git repo is interested in, as an array of dictionary objects.
        """
...
class P4Unshelve(Command):
    ...
    def createShelveParent(self, change, branch_name, sync, origin):
        ...
        sync.commit(parent_description, parent_files, branch_name, origin)
    ...
    def run(self, args):
        ...
        sync.suppress_meta_comment = True   # don't want the [git-p4: depot-paths...] comment

        # figure out the branch structure...
        settings = self.findLastP4Revision('p4/master')
